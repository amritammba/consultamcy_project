...
const styles = StyleSheet.create({
  ...
  progressPercent: { fontSize: FontSizes.sm, color: Colors.textMuted, minWidth: 36 },
  footer: { position: 'absolute', bottom: 40, fontSize: FontSizes.xs, color: Colors.textMuted },
});
